...
const timesUp = new Audio("audio/audio_460133__eschwabe3__robot-affirmative.wav");
const click = new Audio("audio/audio_561660__mattruthsound.wav");
...
//Swap the player's timer after a move (player1 = 1,player2 = 2).
const swapPlayer = () => {
  if (!playing) return;
